...
.thinking-label { font-size: 0.75rem; font-weight: 600; text-transform: uppercase; color: var(--thinking-border); margin-bottom: 8px; }
...
.edit-tool { background: var(--accent-bg); border: 1px solid var(--accent-border); }
.file-tool-header { font-weight: 600; margin-bottom: 4px; display: flex; align-items: center; gap: 8px; font-size: 0.95rem; }
.write-header { color: #2e7d32; }
.edit-header { color: var(--accent-color); }
...
.grep-tool { background: var(--accent-bg); border: 1px solid var(--accent-border); }
.grep-header { color: var(--accent-color); }
...
.ask-user-tool { background: var(--accent-bg); border: 1px solid var(--accent-border); }
.ask-user-tool .tool-header { color: var(--accent-color); }
.ask-user-tool .question-text { color: var(--text-color); }
.ask-user-tool .option { background: var(--card-bg); }
.ask-user-tool .option strong { color: var(--accent-color); }
.ask-user-tool .option-desc { color: var(--text-muted); }
...
.todo-in-progress .todo-icon { color: var(--accent-color); background: rgba(0,0,0,0.1); }
.todo-in-progress .todo-content { color: var(--accent-color); font-weight: 500; }
...
.commit-card-hash { font-family: monospace; color: var(--commit-text); font-weight: 600; margin-right: 8px; }
.index-commit { margin-bottom: 12px; padding: 10px 16px; background: var(--commit-bg); border-left: 4px solid var(--commit-border); border-radius: 8px; box-shadow: 0 1px 2px rgba(0,0,0,0.05); }
.index-commit a { display: block; text-decoration: none; color: inherit; }
.index-commit a:hover { background: rgba(0,0,0,0.05); margin: -10px -16px; padding: 10px 16px; border-radius: 8px; }
.index-commit-header { display: flex; justify-content: space-between; align-items: center; font-size: 0.85rem; margin-bottom: 4px; }
.index-commit-hash { font-family: monospace; color: var(--commit-text); font-weight: 600; }
